...
For the September 2026 dependency and test baseline, start with
[Production readiness](2026-09-10_production_readiness.md). The inventory below
remains historical and is not an up-to-date list of open defects.
