...
### Date: 2026-06-03 15:35:23
### Generated by: src/generate_scripts.py benchmark_broad_2026-06-03 -s odepe_v2_nopolish -r odepe_v2_nopolish_run
...
ic = [0.735, 0.157, 0.595, 0.177, 0.176]
p_true = [0.329, 0.365, 0.557, 0.183, 0.78, 0.784, 0.536, 0.326, 0.724, 0.633, 0.532, 0.386]

time_interval = [0.0, 16.0]
datasize = 750
...
#     per-variable log space). The false Mustache toggle controls whether
