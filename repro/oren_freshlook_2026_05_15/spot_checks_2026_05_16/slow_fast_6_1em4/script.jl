...
### Date: 2026-05-13 22:01:02
### Generated by: src/generate_scripts.py benchmark_numbat_2026-05-13 -s odepe_v2_polish -r odepe_v2_polish_run
### Environment: /pfssfs1/scratch/oren-qc-13/ParameterEstimationBenchmarking/environments/venv

# Local run — using global env
...
measured_quantities = [
    y1 ~ xC,
    y2 ~ 0.44222400000000006*xA*eA + 0.9990000000000001*eB*xB + 1.666*xC*eC,
    y3 ~ 1.332*eA,
    y4 ~ 1.666*eC,
]
