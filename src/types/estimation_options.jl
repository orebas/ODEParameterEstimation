...
- `auto_rescale::Bool`: Opt-in power-of-2 rescaling of states/params/observables/data to O(1) before estimation, with results un-rescaled after (default: false; byte-identical when off). See core/problem_rescaling.jl.
...
Base.@kwdef struct EstimationOptions
	...
	auto_rescale::Bool = false  # Opt-in: power-of-2 rescale states/params/observables/data to O(1) before estimation, un-rescale results after (see core/problem_rescaling.jl). Default OFF = byte-identical.
