# Polynomial system saved on 2025-07-28T15:39:44.041
using Symbolics
using StaticArrays

# Metadata
# num_variables: 12
# timestamp: 2025-07-28T15:39:44.041
# num_equations: 12
...
# Polynomial System
poly_system = [
    -3.0826240854908997 + _t22_x2_t_,
    -9.057672138810949 + _t22_x2ˍt_t_,
    -7.422846758973413 + _t22_x1_t_,
    9.459470740894409 + _t22_x1ˍt_t_,
    _t22_x2ˍt_t_ + _t22_x2_t_*_tpc_ - _t22_x1_t_*_t22_x2_t_*_tpd_,
    _t22_x1ˍt_t_ - _t22_x1_t_*_tpa_ + _t22_x1_t_*_t22_x2_t_*_tpb_,
    -0.46789084382945867 + _t89_x2_t_,
    0.6150442855918825 + _t89_x2ˍt_t_,
    -2.106852299405265 + _t89_x1_t_,
    -2.2730729622829213 + _t89_x1ˍt_t_,
