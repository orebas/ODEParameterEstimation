# Polynomial system saved on 2025-07-28T15:15:42.600
using Symbolics
using StaticArrays

# Metadata
# num_variables: 17
# timestamp: 2025-07-28T15:15:42.600
# num_equations: 18
...
# Polynomial System
poly_system = [
    -1.4129169289976462 + _t390_r_t_,
    1.6193275496084525 + _t390_rˍt_t_,
    -0.6234187807939809 + _t390_rˍtt_t_,
    -4.064739272708544 + _t390_rˍttt_t_,
    ...
    -0.040066119026665015 + _t501_r_t_,
    9.307240622575741e-5 + _t501_rˍt_t_,
    -0.011187678663118558 + _t501_rˍtt_t_,
    0.0054426780033736575 + _t501_rˍttt_t_,
