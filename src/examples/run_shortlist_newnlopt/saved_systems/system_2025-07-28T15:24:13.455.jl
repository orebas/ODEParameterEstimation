# Polynomial system saved on 2025-07-28T15:24:13.455
using Symbolics
using StaticArrays

# Metadata
# num_variables: 17
# timestamp: 2025-07-28T15:24:13.455
# num_equations: 18
...
# Polynomial System
poly_system = [
    1.0536349565003735 + _t445_V_t_,
    2.0239252458500028 + _t445_Vˍt_t_,
    0.5869660542285214 + _t445_Vˍtt_t_,
    -23.73979083405295 + _t445_Vˍttt_t_,
    ...
    1.0604385070420057 + _t501_V_t_,
    2.02576012758929 + _t501_Vˍt_t_,
    0.5005285231472795 + _t501_Vˍtt_t_,
    -34.11184223714468 + _t501_Vˍttt_t_,
