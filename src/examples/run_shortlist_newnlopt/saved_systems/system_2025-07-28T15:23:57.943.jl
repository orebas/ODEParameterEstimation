# Polynomial system saved on 2025-07-28T15:23:57.943
using Symbolics
using StaticArrays

# Metadata
# num_variables: 17
# timestamp: 2025-07-28T15:23:57.943
# num_equations: 18
...
# Polynomial System
poly_system = [
    1.0469593423028538 + _t390_V_t_,
    2.021858061489352 + _t390_Vˍt_t_,
    0.6659085147380409 + _t390_Vˍtt_t_,
    -23.790717150524937 + _t390_Vˍttt_t_,
    ...
    1.0604385068047186 + _t501_V_t_,
    2.0257591463066853 + _t501_Vˍt_t_,
    0.4984363016252975 + _t501_Vˍtt_t_,
    -37.41022458007269 + _t501_Vˍttt_t_,
