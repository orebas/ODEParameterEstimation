# Polynomial system saved on 2025-07-28T15:29:32.091
using Symbolics
using StaticArrays

# Metadata
# num_variables: 8
# timestamp: 2025-07-28T15:29:32.091
# num_equations: 8
...
# Polynomial System
poly_system = [
    -2.9690622332706327 + _t56_Y_t_,
    -0.32090468042941933 + _t56_X_t_,
    -0.02213447547169866 + _t56_Xˍt_t_,
    -1.0 + _t56_Xˍt_t_ + _t56_X_t_*(1 + _tpb_) - (_t56_X_t_^2)*_t56_Y_t_*_tpa_,
    -2.5255865805290254 + _t223_Y_t_,
    -0.5764897599063383 + _t223_X_t_,
    0.46660410822151277 + _t223_Xˍt_t_,
