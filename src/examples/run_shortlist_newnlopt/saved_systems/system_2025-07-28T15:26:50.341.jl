# Polynomial system saved on 2025-07-28T15:26:50.341
using Symbolics
using StaticArrays

# Metadata
# num_variables: 12
# timestamp: 2025-07-28T15:26:50.341
# num_equations: 12
...
# Polynomial System
poly_system = [
    -0.38551705351238175 + _t445_x2_t_,
    0.3715984906879955 + _t445_x2ˍt_t_,
    -2.545129227397976 + _t445_x1_t_,
    -2.934622852691352 + _t445_x1ˍt_t_,
    ...
    -4.804236548820251 + _t501_x2_t_,
    0.8910500141607767 + _t501_x2ˍt_t_,
    -3.5181615977634486 + _t501_x1_t_,
    9.934618564692785 + _t501_x1ˍt_t_,
