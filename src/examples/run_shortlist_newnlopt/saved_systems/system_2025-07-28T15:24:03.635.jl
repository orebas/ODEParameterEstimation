# Polynomial system saved on 2025-07-28T15:24:03.635
using Symbolics
using StaticArrays

# Metadata
# num_variables: 17
# timestamp: 2025-07-28T15:24:03.635
# num_equations: 18
...
# Polynomial System
poly_system = [
    1.0536349564023642 + _t445_V_t_,
    2.0239253264067094 + _t445_Vˍt_t_,
    0.5869792656588053 + _t445_Vˍtt_t_,
    -23.806677960405334 + _t445_Vˍttt_t_,
    ...
    1.060438507209167 + _t501_V_t_,
    2.025760182912937 + _t501_Vˍt_t_,
    0.5010309622702521 + _t501_Vˍtt_t_,
    -33.022949626716986 + _t501_Vˍttt_t_,
