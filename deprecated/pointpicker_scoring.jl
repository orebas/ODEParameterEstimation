# Archived 2026-06-09 from src/core/pointpicker.jl — NOT part of the build.
# Older derivative-scoring point-selection machinery: compute_*_score,
# compute_point_interestingness, pick_points_old. The live pick_points path
# (point-hint + equidistant shooting indices) does not use any of this.
# Parked for a possible future point-selection redesign; reference only.
# ============================================================================
...
# ---- pick_points_old + its (misattributed) docstring ----
"""
