# Archived 2026-06-10 from src/core/optimized_multishot_estimation.jl — NOT part of the build.
# The legacy non-SI-template multishot path (postcampaign review P2): the data-structure
# helpers (PrecomputedDerivatives, EquationTemplate, precompute_all_derivatives,
# build_test_equation_system, analyze_identifiability, create_equation_template,
# build_equations_at_time_point, solve_at_shooting_point) + the use_si_template=false
# fall-through body. Zero external callers; the fall-through crashed anyway on undefined
# `use_adaptive_id` / `process_single_solution`. Reference only.
# ============================================================================

# ---- helpers (was lines 528-1409) ----
# ============================================================================
# Data Structures
# ============================================================================
...
# ---- use_si_template=false fall-through body (was lines 3032-3174) ----
