...
| `Scalar log-space` | `1e-03` | 1 better / 0 tie / 0 worse / 0 unsupported | 0.987x |
| `Bounded LeastSquaresOptim LM log-space` | `0` | 0 better / 1 tie / 0 worse / 0 unsupported | 1.000x |
| `Bounded LeastSquaresOptim LM log-space` | `1e-03` | 1 better / 0 tie / 0 worse / 0 unsupported | 1.119x |
| `Bounded FastLevenbergMarquardt log-space` | `0` | 0 better / 1 tie / 0 worse / 0 unsupported | 1.000x |
| `Bounded FastLevenbergMarquardt log-space` | `1e-03` | 1 better / 0 tie / 0 worse / 0 unsupported | 0.955x |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `seir_3_1em4` | `1e-03` | 0.64% | `1e-03` | 0.18% | `1e-03` | 0.90% |

## Cases Improved vs `λ = 0`

- `Scalar log-space`: seir_3_1em4 (`1e-03`)
