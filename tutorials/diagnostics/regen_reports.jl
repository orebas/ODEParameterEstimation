#= Regenerate diagnostic reports for 4 models with estimation + UQ =#
...
# Suppress noisy logs from SIAN/GP internals
global_logger(ConsoleLogger(stderr, Logging.Error))
redirect_stderr(devnull)

println("=" ^ 72)
println("  Regenerating diagnostic reports (with estimation)")
println("=" ^ 72)
